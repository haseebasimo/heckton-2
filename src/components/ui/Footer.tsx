        ...
        >
            <div className="flex w-[82rem] flex-col gap-10">
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="lg:w-1/2 flex  gap-30 flex-wrap lg:flex-nowrap lg:justify-between ">
                ...
                <div className="flex justify-between items-end flex-col-reverse md:flex-row pt-6 md:border-t
                 font-bold gap-10 md:gap-0">
