                ...
                <div className="flex items-start gap-6 flex-col lg:flex-row">
                    <div className="bg-white p-6 rounded-xl h-fit flex flex-col gap-6 w-full lg:w-1/2 lg:min-w-[24rem]">
                        <div className="flex gap-6 flex-col">
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-cover rounded-lg" src={'/image 8.png'} alt="car-img" width={100} height={100} />
                    ...
                    <div className="rounded-xl size-full flex flex-col gap-6 lg:w-1/2 lg:min-w-[24rem]">
                        ...
                        <div className="flex gap-6 flex-col bg-white p-7 rounded-lg">
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/image 7.png'} alt="car-img" width={100} height={100} />
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/image 8.png'} alt="car-img" width={100} height={100} />
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>Nissan GT - R</div>
                                        <div>
                                            <div className="font-thin text-xs opacity-50">20 July</div>
                                            <div className="font-bold text-sm">$70.00</div>
                                        </div>
                                    </div>
                                    <div className='text-xs opacity-50 flex'>
                                        Sport Car
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/Car.png'} alt="car-img" width={100} height={100} />
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>Rolls-Royce</div>
                                        <div>
                                            <div className="font-thin text-xs opacity-50">20 July</div>
                                            <div className="font-bold text-sm">$96.00</div>
                                        </div>
                                    </div>
                                    <div className='text-xs opacity-50 flex'>
                                        Sport Car
                            ...
                            <div className="flex gap-4 items-center">
                                <Image className="w-28 h-14 object-contain rounded-lg" src={'/Car (2).png'} alt="car-img" width={100} height={100} />
                                <div className="relative flex flex-col w-full" >
                                    <div className="text-xl font-bold flex items-center justify-between">
                                        <div>CR-V</div>
                                        <div>
